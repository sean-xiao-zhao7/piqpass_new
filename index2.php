			...
			<div class='row' style='width: 100%;'>
					<div class='col-md-12 main-bg'>
							<div class='col-md-12'>
								<!-- Desktop Nav -->
								<div class='desktop'>
										<div style="text-align:right; width:100%" class='col-md-6 nav-top-text'><span class='nav'><a href='#story'>About</a> &nbsp;&nbsp;&nbsp;&nbsp; <a href='#benefits'>Team</a> &nbsp;&nbsp;&nbsp;&nbsp; 
<a href='browse.php'>Login</a></span></div>
								</div>
								<!-- Mobile Nav -->
								<div class='col-md-9 mobile'>
											...
											<div class='dropdown row-center' align='center' style='padding-top: 20px;'>
												...
												<ul class='dropdown-menu' aria-labelledby='mode'>
												  <li><a href='#story' ><span style='color: #000;'>About</span></a></li>
													<li><a href='#benefits'><span style='color: #000;'>Team</span></a></li>
							...
							<div class='col-md-3 nav-top nav-left' align='center'><img src='img/logo_transparent_new.png' /></div>
							<div class='col-md-12 header-margin' style='text-transform:uppercase'>
									<div class='col-md-12 large-heading'><center>We are Toronto's</center></div>
									<div class='col-md-12 large-heading'><center>Underground food club</center></div>
<div style="color:white">
<center>
<ul style='list-style-type:circle'>
<li style="display:inline">- Cooking classes from private chefs</li>
<li style="display:inline">- Secret menus to select restaurants & cafes</li>
</ul>
<ul style='list-style-type:circle'>
<li style="display:inline">- Private invite-only dining events</li>
<li style="display:inline">- Free samples from brands & local eateries</li>
</ul>
</center>
</div>
									<div class='col-md-12 desktop' style='margin-top: 50px;'><center><a href='browse.php' class='button-border'>join for free. and get $25 in credits.</a>
</center></div>
