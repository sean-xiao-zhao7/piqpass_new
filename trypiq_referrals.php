...
<html class="no-js" lang="">
	...
	<link rel='stylesheet' type='text/css' href='/css/trypiq.css'>
	...
	<div class='row center-row'>
		...
		<div class='col-md-12 header'>
			...
			<?php include("trypiq_nav.php"); ?>
		</div>
	
	
		<main id='trypiq_main'>

			<h1>Available Credits: <span class='credits'>$25.00</span><h1>
			
			<p class='fine_print'>Credits are applied automatically when you register for a dining event or cooking class.</p>	
			
			<h2>Invite your friends!</h2>
			
			<p>
				Receive $25 for each friend that joins. Invite now!
			</p>
